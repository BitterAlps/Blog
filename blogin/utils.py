...
GITHUB_STAR = 'https://img.shields.io/github/stars/BitterAlps/Blogin?style=social'
GITHUB_FORK = 'https://img.shields.io/github/forks/BitterAlps/Blogin?style=social'
GITHUB_WATCHER = 'https://img.shields.io/github/watchers/BitterAlps/Blogin?style=social'

GITHUB_STAR_DARK = 'https://img.shields.io/github/stars/BitterAlps/Blogin?style=flat-square'
GITHUB_FORK_DARK = 'https://img.shields.io/github/forks/BitterAlps/Blogin?style=flat-square'
GITHUB_WATCHER_DARK = 'https://img.shields.io/github/watchers/BitterAlps/Blogin?style=flat-square'

USER_API = 'https://api.github.com/users/BitterAlps'
REPO_API = 'https://api.github.com/repos/BitterAlps/Blogin'
