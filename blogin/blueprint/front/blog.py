...
def index():
    ...
    su = User.query.filter(User.email == '1503601623@qq.com').first()
...
def new_comment():
    ...
    admin = User.query.filter_by(email='1503601623@qq.com').first()
...
def load_github():
    ...
    return '<div style="border-bottom: 1px solid rgba(58,10,10,0.19); margin-bottom: 5px;padding-bottom: 3px;" class="d-flex">\
                <a href="https://github.com/BitterAlps/" target="_blank"><img class="avatar-s" id="githubAvatar"\
                                                                                alt="avatar"\
                                                                                src="{}"></a>\
                <div class="ml-2">\
                ...
                <a class="btn btn-sm btn-light h-25" id="githubStar"\
                   href="https://github.com/BitterAlps/Blogin" target="_blank">Star</a>\
            </div>\
